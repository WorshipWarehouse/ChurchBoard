...
class Widget(BaseModel):
    ...
    type: Literal["clock", "service", "timing", "assignments", "mics", "slides", "playlist", "notes", "order", "person", "people", "spl", "controls", "lighting", "text", "restream", "obs", "propresenter_timers"]
