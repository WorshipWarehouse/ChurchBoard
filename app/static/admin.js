...
async function loadSettings(){
  ...
  const pc=settings.planning_center||{},pp=settings.propresenter||{},sh=settings.shure||{},se=settings.sennheiser||{},osm=settings.open_sound_meter||{},restream=settings.restream||{},live=pc.live_from_propresenter||{};
...
function settingsPayload(){
  ...
  return {...settings,organization_name:sf.organization_name.value,timezone:sf.timezone.value,demo_mode:sf.demo_mode.checked,
    ...
    restream:{...(settings.restream||{}),enabled:sf.restream_enabled.checked,client_id:sf.restream_client_id.value.trim(),client_secret:sf.restream_client_secret.value},
