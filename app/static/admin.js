...
async function loadSettings(){
  ...
  const pc=settings.planning_center||{},pp=settings.propresenter||{},sh=settings.shure||{},osm=settings.open_sound_meter||{},restream=settings.restream||{},live=pc.live_from_propresenter||{};
