...
const cards=document.querySelector("#dashboard-cards"),sf=document.querySelector("#settings-form"),ppRemoteControlField=sf.elements.namedItem("pp_remote_control_enabled");
...
function settingsPayload(){
  ...
  return {...settings,organization_name:sf.organization_name.value,timezone:sf.timezone.value,demo_mode:sf.demo_mode.checked,
    ...
    propresenter:{...(settings.propresenter||{}),enabled:sf.pp_enabled.checked,host:sf.pp_host.value,port:Number(sf.pp_port.value),remote_control_enabled:ppRemoteControlField.checked},
